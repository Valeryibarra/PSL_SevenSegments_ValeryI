...
public class Core {
	...
	/**
	 * Method that returns the number obtained by joining the array in which the digit is divided into parts
	 * 
	 * @param digitArray Array with the high, middle and low part of the digit(number) respectively
